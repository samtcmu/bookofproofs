...
\chapter{Discrete Probability}
    ...
    \section{Linearity of Variance}
                ...
                \item
                    ...
                    \begin{derivation}{=}
                        \ex{(X + Y)^2} & \ex{X^2 + 2XY + Y^2} \\
                                       & \ex{X^2} + 2\ex{XY} + \ex{Y^2} & \just{By Linearity of Exectation.}
        ...
        \begin{proof}
            ...
            \begin{derivation}{=}
                \var{nX} & \ex{n^2 X^2} - \ex{nX}^2 & \just{By theorem \ref{varformula}.}
                         & n^2 \ex{X^2} - (n \ex{X})^2 & \just{By linearity of expectation (theorem \ref{Linearity of Expectation}).}
                         & n^2(\ex{X^2} - \ex{X}^2)  \\
                         & n^2 \var{X} & \just{By theorem \ref{varformula}}
            \end{derivation}
        ...
        \begin{proof}
            ...
            \begin{derivation}{=}
                \ex{X} & \ex{\sum_{i = 1}^{n} X_i} & \just{By definition of $\dist{X}{\bin{n}{p}}$.}
                       ...
                       & \sum_{i = 1}^{n} p & \just{By $\ex{X_i} = p$ as shown in theorem \ref{bern}.}
                       & np
            \end{derivation}
            ...
            \begin{derivation}{=}
                \var{X} & \var{\sum_{i = 1}^{n} X_i} & \just{By definition of $\dist{X}{\bin{n}{p}}$.}
                        ...
                        & \sum_{i = 1}^n p(1 - p) & \just{By $\var{X_i} = p(1 - p)$ as shown in theorem \ref{bern}.}
                        & np(1 - p)
            \end{derivation}
    ...
    \section{The Geometric Distribution}
        ...
        \begin{proof}
            ...
            \begin{derivation}{=}
                \var{X} & \ex{X^2} - \ex{X}^2 & \just{By theorem \ref{varformula}.}
                        & \dfrac{2 - p}{p^2} - \dfrac{1}{p^2} 
                        & \just{By $\ex{X} = \frac{1}{p}$ and equation \ref{geoxsquared}.}
                        & \dfrac{1 - p}{p^2}
            \end{derivation}
        ...
        \begin{proof}
            ...
            \begin{derivation}{=}
                \pr{X > t} & 1 - \pr{X \le t} & \just{By one of the axioms of probability.}
                           ...
                           & 1 - \dsum_{i = 1}^{t} (1 - p)^{i - 1}p & \just{By $\dist{X}{\geo{p}}$ and theorem \ref{geopmf}.}
        ...
        \begin{proof}
            ...
            conditional probability and lemma \ref{memorylesslemma}. We first invoke the definition
            ...
            \begin{derivation}{=}
                \condpr{X = s + t}{X > s} & \dfrac{\pr{X = s + t}}{\pr{X > s}} \\
                                          ...
                                          & \just{By theorem \ref{geopmf} and lemma \ref{memorylesslemma}.}
                                          & (1 - p)^{t - 1}p \\
                                          & \pr{X = t} & \just{By theorem \ref{geopmf}.}
            \end{derivation}
        ...
        \begin{proof}
            ...
            \begin{derivation}{=}
                \condex{X}{X > s} & \dsum_{n = 1}^{\infty} (s + n) \condpr{X = s + n}{X > s} 
                                  ...
                                  & \just{By theorem \ref{memorylessness}.}
